...
(function () {
    ...
    function buildMixedCommandUrl(villageId, destinationVillage, unitAmounts) {
        var toCoords = destinationVillage.split("|");
        var params = [`village=${villageId}`, "screen=place"];
    ...
    function renderMixedCombinations(snipes, destinationVillage, unitAmounts) {
        ...
        var rows = snipes
            .map(function (snipe, index) {
                ...
                var commandUrl = buildMixedCommandUrl(snipe.id, destinationVillage, unitAmounts);
