// MapGod v7r18: world-driven unit parsing, bounded Multi planning, Rune exclusion and incremental report sync.
try {
...
window.MapGodQuickbar.Main = (function () {
  ...
  panel.innerHTML = `
    <div style="display:flex;justify-content:space-between;align-items:center;background:#7d510f;color:white;padding:6px;margin:-10px -10px 10px -10px">
      <b>MG V7R18 multi-cache</b><button id="mgq_x">X</button>
    </div>
  ...
  async function loadOrigins(force) {
    ...
    console.log('[MapGodQuickbar] origin import', {
