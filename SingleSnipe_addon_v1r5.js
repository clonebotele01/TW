...
(function () {
    ...
    var TIMERGOD_SCRIPT_URL = "https://cdn.jsdelivr.net/gh/clonebotele01/TW@main/TimeGod_v1r2.js";
    ...
    function buildMixedCommandData(villageId, destinationVillage, unitAmounts, arrivalTimeMs) {
        var toCoords = destinationVillage.split("|");
        var actionParams = [];
        var fields = {};
        var targetVillageId =
        ...
        return {
            ...
            fields: fields,
            fallbackUrl: buildMixedCommandUrl(villageId, destinationVillage, unitAmounts, arrivalTimeMs)
        };
    }
    ...
    function renderMixedCombinations(snipes, destinationVillage, unitAmounts) {
        ...
        var rows = snipes
            .map(function (snipe, index) {
                ...
                var commandData = buildMixedCommandData(snipe.id, destinationVillage, unitAmounts, snipe.arrivalTime);
