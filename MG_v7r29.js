// MapGod v7r29: authoritative current-origin units, exact Multi diagnostics, and full-haul B override.
try {
...
window.MapGodQuickbar.Main = (function () {
  ...
  const ORIGIN_CACHE_KEY = 'mapgod_origin_cache_v7r29';
  ...
  panel.innerHTML = `
    <div style="display:flex;justify-content:space-between;align-items:center;background:#7d510f;color:white;padding:6px;margin:-10px -10px 10px -10px">
      <b>MG V7R29 multi-cache</b><button id="mgq_x">X</button>
    </div>
