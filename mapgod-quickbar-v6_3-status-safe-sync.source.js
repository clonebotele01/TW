...
window.MapGodQuickbar.Main = (function () {
  ...
  function importData() {
    ...
    try {
      ...
      if (payload.history && typeof payload.history === 'object') saveHistory(payload.history);
      if (payload.settings && typeof payload.settings === 'object') localStorage.setItem(SETTINGS_KEY, JSON.stringify(payload.settings));
